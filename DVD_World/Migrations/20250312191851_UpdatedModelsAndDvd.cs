...
{
    /// <inheritdoc />
    public partial class UpdatedModelsAndDvd : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchasingInvoices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PurchasingInvoices_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchasingInvoices_Suppliers_SupplierId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchasingInvoices_ProductId",
                table: "PurchasingInvoices",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchasingInvoices_SupplierId",
                table: "PurchasingInvoices",
                column: "SupplierId");
        }
